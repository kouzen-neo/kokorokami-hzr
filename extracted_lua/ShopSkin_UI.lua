...
function M:ctor()
    ...
    self.CC = {
        -- Image 列表
        {'Img_BG','Img_BG',2},{'LihuiPanel','SkinPanel/LihuiPanel',2},{'LihuiSpinePanel','SkinPanel/LihuiPanel/LihuiSpinePanel',2},{'BgSprite','SkinPanel/LihuiPanel/BgSprite',2},{'FrontSprite','SkinPanel/LihuiPanel/FrontSprite',2},{'RoleSprite','SkinPanel/LihuiPanel/RoleSpritePanel/RoleSprite',2},{'ActorSwitch','SkinPanel/LihuiPanel/RoleSpritePanel/ActorSwitch',2},{'SkinName','SkinPanel/SkinName/SkinName',2},{'RoleNameBG','SkinPanel/SkinName/RoleNameBG',2},{'Time','SkinPanel/SkinName/Time',2},{'SkinFrame','SkinPanel/SkinFrame',2},{'BiaoqianPrefab','SkinPanel/SkinFrame/BiaoqianPrefab',2},{'BG','SkinPanel/SkinFrame/BiaoqianPrefab/BG',2},{'BiaoqianContent','SkinPanel/SkinFrame/BiaoqianContent',2},{'Img_Zuanshicon','SkinPanel/SkinFrame/Panel/Img_Zuanshicon',2},{'Panel','SkinPanel/SkinFrame/Panel/Text_Original/Panel',2},{'Btn_Buy','SkinPanel/SkinFrame/Btn_Buy',2},{'Btn_HuodongBuy','SkinPanel/SkinFrame/Btn_HuodongBuy',2},{'BottomPanel','SkinPanel/BottomPanel',2},{'content','SkinPanel/BottomPanel/SkinTeam/content',2},{'Img_Fenggexian','TopView/UpperLeftPanel/Img_Fenggexian',2},{'Btn_I','TopView/UpperLeftPanel/Btn_I',2},{'Btn_ReturnBg','TopView/UpperLeftPanel/Btn_ReturnBg',2},{'Btn_Return','TopView/UpperLeftPanel/Btn_ReturnBg/Btn_Return',2},{'Btn_Home','TopView/UpperLeftPanel/Btn_ReturnBg/Btn_Home',2},{'Btn_ZuanShi','TopView/Huobi/Btn_ZuanShi',2},{'Btn_Add','TopView/Huobi/Btn_ZuanShi/Btn_Add',2},{'Img_Zuanshicon01','TopView/Huobi/Btn_ZuanShi/Img_Zuanshicon',2},
        -- UITemplate 列表
        {'SkinPrefab','SkinPanel/BottomPanel/SkinTeam/SkinPrefab',10},
        -- LoopScrollRect 列表
        {'SkinTeam','SkinPanel/BottomPanel/SkinTeam',18},
        -- TextMeshProUGUI 列表
        {'Tishishuiyin','Tishishuiyin',20},{'RoleNameTxt','SkinPanel/SkinName/RoleNameBG/RoleNameTxt',20},{'Text_Shengyushijian','SkinPanel/SkinName/Time/Text_Shengyushijian',20},{'Txt','SkinPanel/SkinFrame/BiaoqianPrefab/BG/Txt',20},{'Text_PriceNow','SkinPanel/SkinFrame/Panel/Text_PriceNow',20},{'Text_Original','SkinPanel/SkinFrame/Panel/Text_Original',20},{'Text_Buy','SkinPanel/SkinFrame/Btn_Buy/Text_Buy',20},{'Text_Buy01','SkinPanel/SkinFrame/Btn_HuodongBuy/Text_Buy',20},{'Text_SkinShop_CN','TopView/UpperLeftPanel/Text_SkinShop/Text_SkinShop_CN',20},{'Text_SkinShop_EN','TopView/UpperLeftPanel/Text_SkinShop/Text_SkinShop_EN',20},{'Text_ZSCount','TopView/Huobi/Btn_ZuanShi/Text_ZSCount',20},
    }
end
...
function M:OnInit()
    ...
    --皮肤跳转抽卡
    UIEvent.LuaClick(self.Btn_HuodongBuy().gameObject,function()
        MgrLink.LinkStart(self.SkinLink)
    end)
...
function M:UpdateSkin(skinData)
    ...
    UnityEngine.Debug.LogError(skinData.roleId)
    UnityEngine.Debug.LogError(HeroControl.GetRoleDataByID(skinData.roleId))
    ...
    --跳转抽皮肤界面按钮
    self.SkinLink = nil
    for i, v in ipairs(ShopControl.GetRandomSkinData()) do
        --活动开启中的活动
        local tActivityData = ActivityControl.GetActivityByID(v.actId)
        if tActivityData and Global.isMiddleTime(tActivityData.beginTime_Stamp,tActivityData.endTime_Stamp) and not ActivityControl.CheckBuyGiftState(v.actId) then
            if v.skinList[skinData.id] then
                self.SkinLink = v.linkId
                break
            end
        end
    end
    self.Btn_HuodongBuy().gameObject:SetActive(self.SkinLink ~= nil and not skinData.unlockState)
end
