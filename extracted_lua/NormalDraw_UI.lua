...
function M:ResetItem(id)
    ...
    if data.cardType == 1 then --角色招募
        ...
        self.Text_Time().text = openTime[1].."/"..openTime[2].."/"..openTime[3].." "..openTime[4]..":"..openTime[5].."~"..endTime[1].."/"..endTime[2].."/"..endTime[3].." "..endTime[4]..":"..endTime[5].." "..tUTC
    ...
    elseif data.cardType == 2 then  --装备补给
        ...
        local tUTC = SteamLocalData.tab[112011][2]
        self.Text_Time2().text = openTime[1].."/"..openTime[2].."/"..openTime[3].." "..openTime[4]..":"..openTime[5].."~"..endTime[1].."/"..endTime[2].."/"..endTime[3].." "..endTime[4]..":"..endTime[5].." "..tUTC
        ---点击查看武器卡池详情
    ...
    elseif data.cardType == 3 then
        ...
        local tUTC = SteamLocalData.tab[112011][2]
        self.Text_Time_Prize().text = openTime[1].."/"..openTime[2].."/"..openTime[3].." "..openTime[4]..":"..openTime[5].."~"..endTime[1].."/"..endTime[2].."/"..endTime[3].." "..endTime[4]..":"..endTime[5].." "..tUTC
    ...
    elseif data.cardType == 4 then
        ...
        local endTime =  string.split(drawData.timeEnd,'-')
        local tUTC = SteamLocalData.tab[112011][2]
        self.Text_Time4().text = openTime[1].."/"..openTime[2].."/"..openTime[3].." "..openTime[4]..":"..openTime[5].."~"..endTime[1].."/"..endTime[2].."/"..endTime[3].." "..endTime[4]..":"..endTime[5].." "..tUTC
