...
function M:ctor()
    ...
    self.CC = {
        -- Image 列表
        {'Background','Background',2},{'Img_Taskdi','RightPanel/Img_Taskdi',2},{'lihui_task','RightPanel/lihui_task',2},{'Btn_Lingqu','RightPanel/Btn_Lingqu',2},{'ReturnBg','ReturnBg',2},{'Btn_GoMenu','ReturnBg/Btn_GoMenu',2},{'Btn_Back','ReturnBg/Btn_Back',2},{'Img_Fenggexian','ReturnBg/Img_Fenggexian',2},
        -- UITemplate 列表
        ...
        -- TextMeshProUGUI 列表
        {'Text_Lingqu','RightPanel/Btn_Lingqu/Text_Lingqu',20},{'Text_Title_CN','ReturnBg/Text_Title/Text_Title_CN',20},{'Text_Title_EN','ReturnBg/Text_Title/Text_Title_EN',20},
    }
end
