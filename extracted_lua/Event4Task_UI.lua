...
function M:ctor()
    ...
    self.CC = {
        -- Image 列表
        {'Background','Background',2},{'Role','Role',2},{'SpineRole','Role/SpineRole',2},{'RoleClickArea','Role/SpineRole/RoleClickArea',2},{'UI_Canvas','UI_Canvas',2},{'ReturnBg','UI_Canvas/ReturnBg',2},{'Btn_GoMenu','UI_Canvas/ReturnBg/Btn_GoMenu',2},{'Btn_Back','UI_Canvas/ReturnBg/Btn_Back',2},{'Img_Fenggexian','UI_Canvas/ReturnBg/Img_Fenggexian',2},{'Img_SoundTextBG','UI_Canvas/Img_SoundTextBG',2},{'Img_Taskdi','UI_Canvas/RightPanel/Img_Taskdi',2},{'Type','UI_Canvas/RightPanel/Type',2},{'Daily','UI_Canvas/RightPanel/Type/Daily',2},{'Normal','UI_Canvas/RightPanel/Type/Daily/Normal',2},{'NormalIcon','UI_Canvas/RightPanel/Type/Daily/Normal/NormalIcon',2},{'HighLight','UI_Canvas/RightPanel/Type/Daily/HighLight',2},{'NormalIcon01','UI_Canvas/RightPanel/Type/Daily/HighLight/NormalIcon',2},{'DailyRedDotIcon','UI_Canvas/RightPanel/Type/Daily/DailyRedDotIcon',2},{'Ac','UI_Canvas/RightPanel/Type/Ac',2},{'Normal01','UI_Canvas/RightPanel/Type/Ac/Normal',2},{'NormalIcon02','UI_Canvas/RightPanel/Type/Ac/Normal/NormalIcon',2},{'HighLight01','UI_Canvas/RightPanel/Type/Ac/HighLight',2},{'NormalIcon03','UI_Canvas/RightPanel/Type/Ac/HighLight/NormalIcon',2},{'AcRedDotIcon','UI_Canvas/RightPanel/Type/Ac/AcRedDotIcon',2},{'TaskContent','UI_Canvas/RightPanel/VFXMask/TaskScroll/TaskContent',2},{'Btn_Lingqu','UI_Canvas/RightPanel/Btn_Lingqu',2},
        -- UITemplate 列表
        ...
        -- TextMeshProUGUI 列表
        {'Text_Title_CN','UI_Canvas/ReturnBg/Text_Title/Text_Title_CN',20},{'Text_Title_EN','UI_Canvas/ReturnBg/Text_Title/Text_Title_EN',20},{'RoleVoiceWordText','UI_Canvas/Img_SoundTextBG/RoleVoiceWordText',20},{'Text_Daily','UI_Canvas/RightPanel/Type/Daily/Normal/Text_Daily',20},{'Text_Daily01','UI_Canvas/RightPanel/Type/Daily/HighLight/Text_Daily',20},{'Text_Daily02','UI_Canvas/RightPanel/Type/Ac/Normal/Text_Daily',20},{'Text_Daily03','UI_Canvas/RightPanel/Type/Ac/HighLight/Text_Daily',20},{'Text_Lingqu','UI_Canvas/RightPanel/Btn_Lingqu/Text_Lingqu',20},
    }
end
