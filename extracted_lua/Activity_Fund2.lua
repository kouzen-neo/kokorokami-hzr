...
function M:ctor()
    ...
    self.CC = {
        -- Image 列表
        {'Activity_Fund2','/',2},{'TaskPanel','TaskPanel',2},{'Jiangli','TaskPanel/Jiangli',2},{'Content','TaskPanel/TaskAwardScroll/Content',2},{'Btn_UnTaskceive','TaskPanel/Btn_UnTaskceive',2},{'Btn_TaskCeive','TaskPanel/Btn_TaskCeive',2},
        -- UITemplate 列表
