...
function M:InitBtn()
    ...
    UIEvent.LuaClick(self.Btn_Goumai().gameObject,function()
        ...
        self.m_monthCardDurationId = 111003
    ...
    UIEvent.LuaClick(self.BtnBuyTili().gameObject,function()
        ...
        self.m_monthCardDurationId = 111024
    ...
    UIEvent.LuaClick(self.Btn_confirm().gameObject,function()
        if self.m_monthCardRemaining + tonumber(SteamLocalData.tab[self.m_monthCardDurationId][2]) >= tonumber(SteamLocalData.tab[self.m_monthCardLimit][2]) then
