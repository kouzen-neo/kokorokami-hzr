...
function M:InitPlayerInfo()
    ...
    local value = self.FriendData.roleNum /allhero
...
function M:CreatSpine(_Root,_RoleId)
    ...
    Global.SetCoordinate(self.HDImage(), CharactercoordinatesLocalData.tab[_RoleId].coordinate14);
end
