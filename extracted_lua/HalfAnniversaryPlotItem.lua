...
function M:OnUpdateUI(pData)
    ...
    if tCurLevelId == nil then
        self.DreamPlot().gameObject:SetActive(false)
        return
    else
        self.DreamPlot().gameObject:SetActive(true)
    end
    self.CurPointData = StormControl.GetStormPointByID(tCurLevelId)
