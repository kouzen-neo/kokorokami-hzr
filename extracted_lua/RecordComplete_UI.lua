...
function M:ctor()
    ...
    self.CC = {
        ...
        -- TextMeshProUGUI 列表
        {'Text_Queding','Btn_Confirm/Text_Queding',20},{'Text_Chakanxiangqing','Btn_CheckInfo/Text_Chakanxiangqing',20},{'Text_DefScore','DefPanel/Text_DefScore',20},{'Text_DefRank','DefPanel/Text_DefRank',20},{'Text_DefChangeSore','DefPanel/Img_Changebg/Text_DefChangeSore',20},{'Text_AtkScore','AtkPanel/Text_AtkScore',20},{'Text_AtkRank','AtkPanel/Text_AtkRank',20},{'Text_AtkChangeSore','AtkPanel/Img_Changebg/Text_AtkChangeSore',20},{'Text_AtkResult','AtkPanel/Text_AtkResult',20},{'Text_AtkName','AtkPanel/Text_AtkName',20},{'Text_Jinggongfang1','AtkPanel/Text_Jinggongfang1',20},{'Text_Huifangjieshu','Title/Text_Huifangjieshu',20},
    }
end
...
function M:OnShow(pData)
    if PVPViewModel.PlayerIsAtk then
        ...
        if PVPViewModel.RecordResult.result == 2 then
            MgrSound.PlayEffect("Battle-win",1,nil,false)
            ...
            MgrSound.PlayEffect("Battle-lose",1,nil,false)
