...
function M:OnShow(args)
    ...
    UnityEngine.DebugEx.LogError("[QuickIOS] ItemAchievePop_UI.OnShow. items: " .. #self.items)
...
function M:ResetItem()
    ---获取当前loop数据
    UnityEngine.DebugEx.LogError("[QuickIOS] ItemAchievePop_UI.ResetItem. totalCount: " .. #self.CurLoopList)
