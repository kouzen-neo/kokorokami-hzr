...
function M:ctor()
    ...
    self.CC = {
        ...
        {'SynthesisItem01','/',10},
        -- TextMeshProUGUI 列表
        {'Text_Count','Item1/ItemPanel/Text_Count',20},{'Text_Count01','Item2/ItemPanel/Text_Count',20},{'Text_Count02','Item3/ItemPanel/Text_Count',20},{'Text_Weijiesuo','Weijiesuo/zhezhao/Text_Weijiesuo',20},
    }
end
