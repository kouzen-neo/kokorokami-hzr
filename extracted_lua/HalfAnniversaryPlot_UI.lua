...
function M:ctor()
    ...
    self.CC = {
        -- Image 列表
        {'Background','Background',2},{'PlotScroll','PlotScroll',2},{'HalfAnniversaryPlotItem','PlotScroll/HalfAnniversaryPlotItem',2},{'Content','PlotScroll/Content',2},{'Frontground','Frontground',2},{'ReturnBg','ReturnBg',2},{'Btn_GoMenu','ReturnBg/Btn_GoMenu',2},{'Btn_Back','ReturnBg/Btn_Back',2},{'Img_Fenggexian','ReturnBg/Img_Fenggexian',2},{'Btn_Help','ReturnBg/Btn_Help',2},
        -- UITemplate 列表
...
function M:OnUpdateUI()
    self.PlotScroll01().totalCount = #self.PlotList.levels+1
    self.PlotScroll01():RefillCells()
end

function M:CellItem(trans, idx)
    trans:GetComponent("UITemplate"):SetData({ self.PlotList.levels[idx],idx })
end
