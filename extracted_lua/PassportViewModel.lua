...
function PassportViewModel.BuyPassportLevel(parentUI,count)
    ...
    MgrUI.Pop(UID.ConfirmPop_UI,
            { string.format(MgrLanguageData.GetLanguageByKey("passportviewmodel_tips2"),passLevelUpCost.consumeNum * count ) .. string.format(MgrLanguageData.GetLanguageByKey("passportviewmodel_tips3"),tostring(count)),
