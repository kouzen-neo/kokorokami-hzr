...
function M:TouchUpdate()
    ...
    self.SliderChange = true
    self.Text_Scale1().text = string.format(MgrLanguageData.GetLanguageByKey("ui_tongyong_text279"), str[1])
    self.Text_Scale3().text = string.format(MgrLanguageData.GetLanguageByKey("ui_tongyong_text279"), str[2])
    --设置边界
