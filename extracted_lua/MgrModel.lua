...
--[[    ---签到根节点
    ...
    RedDotControl.RegisterChildDot("Office","Ark")
    RedDotControl.RegisterChildDot("PersonalPlot","Office")
    ---公告根节点
    ...
    --限时签到
    RedDotControl.RegisterChildDot("limitSign","Activity")
    --半周年
    ...
    --礼包直购
    RedDotControl.RegisterChildDot("ActiveGift","Activity")
    --累销活动(宇宙秘藏)
...
function MgrModel.PushData(data, isReconnet)
    ...
    StormControl.SaveWeekBossTime(data.weekCopyNum)             ---更新周本次数
