...
function M:ctor()
    ...
    self.CC = {
        -- Image 列表
        {'Activity_HalfAnniversary','/',2},{'EventName','TitleGroup/EventName',2},{'EventTime','TitleGroup/EventTime',2},{'Btn_Qianwanghuodong','Btn_Qianwanghuodong',2},{'Img_di','Btn_Qianwanghuodong/Img_di',2},{'Img_Raid_En','Btn_Qianwanghuodong/Img_Raid_En',2},{'Text_Raid','Btn_Qianwanghuodong/Text_Raid',2},
        -- UITemplate 列表
...
function M:OnUpdateUI(pData)
    ...
    local _time = beginTime[2].."/"..beginTime[3].." "..beginTime[4]..":"..beginTime[5].."~"..
            tEndTime[2].."/"..tEndTime[3].." "..tEndTime[4]..":"..tEndTime[5].." "..tUTC
