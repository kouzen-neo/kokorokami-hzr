                        ...
                        for k, change in ipairs(skill.changes) do
                            ...
                            if nil ~= change.buffs then
                                for l, buff in ipairs(change.buffs) do
                                    content = content .. i .. "." .. j .. "." .. k .. "." .. l .. ". Buff id: " .. buff.buffID .. ", skill: " .. buff.skillID .. ", duration: " .. buff.duration .. "\n";
                                end
                            end
                            --- damage
                            ...
                            --- props
                            if nil ~= change.props then
                                for l, prop in ipairs(change.props) do
                                    content = content .. i .. "." .. j .. "." .. k .. "." .. l .. ". Prop: " .. prop.field .. ", Value: " .. prop.value .. "\n";
                                end
                            end
                            --- shield
                            if nil ~= change.shield then
                                for l, shield in ipairs(change.shield) do
                                    content = content .. i .. "." .. j .. "." .. k .. "." .. l .. ". Shield: " .. shield .. "\n";
                                end
                            end
                        end
                        --- changes end
