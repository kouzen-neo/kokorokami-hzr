...
function M:InitUI()
    ...
    if tActive and tActive.beginTime ~= "0" and tActive.endTime ~= "0" then
        ...
        local tStr = tBegin[1].."/"..tBegin[2].."/"..tBegin[3].."~"..tEnd[1].."/"..tEnd[2].."/"..tEnd[3].." "..tUTC
