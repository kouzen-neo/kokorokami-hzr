...
function M:OnUpdateUI(pData)
    ...
    if self.pointData and self.pointData:CheckLock() then
        ...
        self.Text_PointName_Light().text = MgrLanguageData.GetLanguageByKey("hongdong_tips_1");
        self.Text_PointName_Black().text = MgrLanguageData.GetLanguageByKey("hongdong_tips_1");
    end
