...
function M:UpdataRoleInfoPanel(attr)
    if RoleCardViewModel.CurType == "Normal" then
        ...
        self.ZhiYuanInfoTxt().text = "" .. math.floor(self:GetInfoCorrect(tempRole.RealSuppart)) .. "%"
        self.DefInfoTxt().text = "" .. math.floor((self:GetInfoCorrect(tempRole.RealDef))) .. "%"
        self.MinjieInfoTxt().text = "" .. math.floor((self:GetInfoCorrect(tempRole.RealAgile))) .. "%"
        self.BaojiInfoTxt().text = "" .. math.floor((self:GetInfoCorrect(tempRole.RealCrit))) .. "%"
        self.BaoshangInfoTxt().text = "" .. math.floor((self:GetInfoCorrect(tempRole.RealCritDmg))) .. "%"
    ...
    elseif RoleCardViewModel.CurType == "Friend" then
        ...
        self.ZhiYuanInfoTxt().text = "" .. (self:GetInfoCorrect(self.CurFheroAttr.RealSuppart)) .. "%"       ---支援力
...
function M:SetAttrText(_ObjText, _totleV, _baseV, _isRate)
    ...
    if math.floor(tTotleV) > math.floor(tBaseV) then
        if _isRate then
            ...
            _ObjText.text = "(+" .. math.floor(tTotleV - tBaseV) .. ")"
        end
    else
        _ObjText.text = ""
    end
...
function M:InitRoleInfoPanel()
    ...
    self.SupInfoTxt().text = "" .. (self:GetInfoCorrect(tCurBattleRole.RealSuppart + tempSuppart)) .. "%"
