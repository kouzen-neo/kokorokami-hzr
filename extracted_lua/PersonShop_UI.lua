...
function M:ctor()
    ...
    self.CC = {
        ...
        -- TextMeshProUGUI 列表
        {'RoleVoiceWordText','Role/Img_SoundTextBG/RoleVoiceWordText',20},{'ItemText','UI_Canvas/SpecialPanel/SpecialScroll/SpecialItem/ItemText',20},{'MaskText','UI_Canvas/SpecialPanel/SpecialScroll/SpecialItem/BagItem/Mask/MaskText',20},{'Text_TenDraw','UI_Canvas/RightPanel/Niudanji/Btn_Chou10ci/Text_TenDraw',20},{'Text_TebDrawPrice','UI_Canvas/RightPanel/Niudanji/Btn_Chou10ci/Text_TebDrawPrice',20},{'Text_shuliang','UI_Canvas/RightPanel/Niudanji/Btn_Chou1ci/Text_shuliang',20},{'Text_xiaohao','UI_Canvas/RightPanel/Niudanji/Btn_Chou1ci/Text_xiaohao',20},{'Text_Title_CN','UI_Canvas/ReturnBg/Text_Title/Text_Title_CN',20},{'Text_Title_EN','UI_Canvas/ReturnBg/Text_Title/Text_Title_EN',20},
    }
end
