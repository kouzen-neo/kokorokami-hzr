...
function M:BossUI()
    ...
    for i,v in ipairs(self.ChapterBoss.levels) do
        ...
        ---推荐等级
        go.transform:Find("Text_TuijianLv").transform:GetComponent("TextMeshProUGUI").text = string.format(MgrLanguageData.GetLanguageByKey("ui_tongyong_text262"), self.AllPointData[i].recommendLevel)
        ---Boss弹窗
