...
function M:InitBattleUI()
    ...
    self.Img_Speedx1().gameObject:SetActive(speed == 1)
    self.Img_Speedx2().gameObject:SetActive(speed == 2)
    self.Img_Speedx2().gameObject:SetActive(false)
    --self.Img_Speedx3().gameObject:SetActive(speed == 3)
    ---注册播放速度按钮
    UIEvent.LuaClick(self.Btn_Speed().gameObject,function()
        local speed = SettingViewModel:GetBattleSpeed()
        if speed == 1 then
            SettingViewModel.SetBattleSpeed(2)
            CJNUIMgr.SetUIDoScale(self.Img_Speedx2().gameObject,0,0.2,2,1,1,1.5,1.5)
            CJNUIMgr.SetUIDoScale(self.Img_Speedx2().gameObject,0.2,0.2,2,1.5,1.5,1,1)
        elseif speed == 2 then
        --    SettingViewModel.SetBattleSpeed(3)
        --    CJNUIMgr.SetUIDoScale(self.Img_Speedx3().gameObject,0,0.2,2,1,1,1.5,1.5)
        --    CJNUIMgr.SetUIDoScale(self.Img_Speedx3().gameObject,0.2,0.2,2,1.5,1.5,1,1)
        --elseif speed == 3 then
            SettingViewModel.SetBattleSpeed(1)
            CJNUIMgr.SetUIDoScale(self.Img_Speedx1().gameObject,0,0.2,2,1,1,1.5,1.5)
            CJNUIMgr.SetUIDoScale(self.Img_Speedx1().gameObject,0.2,0.2,2,1.5,1.5,1,1)
        end
        ...
        --self.Img_Speedx1().gameObject:SetActive(speed == 3)
        self.Img_Speedx1().gameObject:SetActive(speed == 2)
        self.Img_Speedx2().gameObject:SetActive(speed == 1)
        --self.Img_Speedx3().gameObject:SetActive(speed == 2)
    end)
    ---注册暂停按钮
