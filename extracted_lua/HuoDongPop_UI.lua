...
function M:ctor()
    ...
    self.CC = {
        -- Image 列表
        {'zuo','zuo',2},{'you','you',2},{'ClickMaskImg','ClickMaskImg',2},{'Activity_SevenDaySign','Activity_SevenDaySign',2},{'Activity_Newcome','Activity_Newcome',2},{'Activity_DailySign','Activity_DailySign',2},{'Activity_Boss','Activity_Boss',2},{'Activity_Summer','Activity_Summer',2},{'Activity_Plot3','Activity_Plot3',2},{'Activity_Zhanshuzhidao','Activity_Zhanshuzhidao',2},{'Activity_Fund2','Activity_Fund2',2},{'Activity_Fund3','Activity_Fund3',2},{'Activity_SummerYure','Activity_SummerYure',2},{'Activity_HaiYueHuanShuo','Activity_HaiYueHuanShuo',2},{'Activity_Yueta','Activity_Yueta',2},{'Activity_Event4Preheat','Activity_Event4Preheat',2},{'Activity_LimitSign','Activity_LimitSign',2},{'Activity_Huigui','Activity_Huigui',2},{'Activity_Event4','Activity_Event4',2},{'Activity_Cake','Activity_Cake',2},{'Activity_Fund','Activity_Fund',2},{'Activity_ChapterTask','Activity_ChapterTask',2},{'Activity_WudaohuiPVP','Activity_WudaohuiPVP',2},{'Activity_HalfAnniversary','Activity_HalfAnniversary',2},{'Activity_Gift','Activity_Gift',2},{'Activity_Power','Activity_Power',2},{'Activity_SignAll','Activity_SignAll',2},{'Activity_FirstCharge','Activity_FirstCharge',2},{'Activity_Boss2','Activity_Boss2',2},{'Activity_Gacha','Activity_Gacha',2},{'Activity_TimeLimitSign','Activity_TimeLimitSign',2},{'Activity_PersonStory','Activity_PersonStory',2},{'SwitchPanel','SwitchPanel',2},{'HuoDongToggle','SwitchPanel/VFXMask/SwitchScroll/HuoDongToggle',2},{'SelectImg','SwitchPanel/VFXMask/SwitchScroll/HuoDongToggle/SelectImg',2},{'RedDotIcon','SwitchPanel/VFXMask/SwitchScroll/HuoDongToggle/RedDotIcon',2},{'Btn_suo','SwitchPanel/VFXMask/SwitchScroll/HuoDongToggle/Btn_suo',2},{'Img_suo','SwitchPanel/VFXMask/SwitchScroll/HuoDongToggle/Btn_suo/Img_suo',2},{'SwitchContent','SwitchPanel/VFXMask/SwitchScroll/SwitchContent',2},{'Btn_Return','UpperLeftPanel/Btn_Return',2},{'Btn_Help','UpperLeftPanel/Btn_Help',2},{'Img_Fenggexian','UpperLeftPanel/Img_Fenggexian',2},{'NewcomeItemPop','NewcomeItemPop',2},{'BlurMask','NewcomeItemPop/BlurMask',2},{'ClickBackArea','NewcomeItemPop/ClickBackArea',2},{'ClickBackAreaMask','NewcomeItemPop/ClickBackAreaMask',2},{'Img_Xian1','NewcomeItemPop/Img_Xian1',2},{'Img_Xian2','NewcomeItemPop/Img_Xian2',2},{'Img_Tanchuangdi','NewcomeItemPop/Img_Tanchuangdi',2},{'HuoDongPopItem','NewcomeItemPop/Img_Tanchuangdi/bg/HuoDongPopItem',2},{'biaotixian','NewcomeItemPop/Img_Tanchuangdi/PanelTitleText/biaotixian',2},{'AllMask','AllMask',2},
        -- UITemplate 列表
        {'Activity_SevenDaySign01','Activity_SevenDaySign',10},{'Activity_Newcome01','Activity_Newcome',10},{'Activity_DailySign01','Activity_DailySign',10},{'Activity_Boss01','Activity_Boss',10},{'Activity_Summer01','Activity_Summer',10},{'Activity_Plot301','Activity_Plot3',10},{'Activity_Zhanshuzhidao01','Activity_Zhanshuzhidao',10},{'Activity_Fund201','Activity_Fund2',10},{'Activity_Fund301','Activity_Fund3',10},{'Activity_SummerYure01','Activity_SummerYure',10},{'Activity_HaiYueHuanShuo01','Activity_HaiYueHuanShuo',10},{'Activity_Yueta01','Activity_Yueta',10},{'Activity_Event4Preheat01','Activity_Event4Preheat',10},{'Activity_LimitSign01','Activity_LimitSign',10},{'Activity_Huigui01','Activity_Huigui',10},{'Activity_Event401','Activity_Event4',10},{'Activity_Cake01','Activity_Cake',10},{'Activity_Fund01','Activity_Fund',10},{'Activity_ChapterTask01','Activity_ChapterTask',10},{'Activity_WudaohuiPVP01','Activity_WudaohuiPVP',10},{'Activity_HalfAnniversary01','Activity_HalfAnniversary',10},{'Activity_Gift01','Activity_Gift',10},{'Activity_Power01','Activity_Power',10},{'Activity_SignAll01','Activity_SignAll',10},{'Activity_FirstCharge01','Activity_FirstCharge',10},{'Activity_Boss201','Activity_Boss2',10},{'Activity_Gacha01','Activity_Gacha',10},{'Activity_TimeLimitSign01','Activity_TimeLimitSign',10},{'Activity_PersonStory01','Activity_PersonStory',10},{'Activity_CumulativeSales','Activity_CumulativeSales',10},{'Activity_CumulativeSales2','Activity_CumulativeSales2',10},{'Activity_Bingo','Activity_Bingo',10},{'HuoDongPopItem01','NewcomeItemPop/Img_Tanchuangdi/bg/HuoDongPopItem',10},
        -- Toggle 列表
...
function M:OnInit()
    ...
    self.Activity_Cake().gameObject:SetActive(false)
    self.Activity_PersonStory().gameObject:SetActive(false)
...
function M:ToggleEvent(trans,idx)
    ...
    Tools.ToggleValueChange(toggle,function(isOn,curTog)
        if isOn then
            ...
            MgrUI.GetUICamera().orthographic = falseG
            self.CurPageID = idx
            ...
            elseif self.ActivityData[idx].activityType == ActivityControl.activityTypeEnum.GIFT_GACHA then
                --礼包抽奖
                self.Activity_Gacha01():SetData({self.ActivityData[idx].activityId})
                self:SwitchUI(self.Activity_Gacha())
            ...
            elseif self.ActivityData[idx].activityType == ActivityControl.activityTypeEnum.CUMULATIVE_SALES then
                ...
                -- 保持与返回界面时的参数结构一致
                activityPanel:SetData({self.ActivityData[idx].activityId, self})
    ...
    elseif self.ActivityData[idx].activityType == ActivityControl.activityTypeEnum.LIMITSIGN then
        ---限时签到
        self.RedDotList["limitSign"] = trans.transform:Find("RedDotIcon").gameObject
    elseif self.ActivityData[idx].activityType == ActivityControl.activityTypeEnum.LIMITSIGN_NEW then
        ---新限时签到
    ...
    elseif self.ActivityData[idx].activityType == ActivityControl.activityTypeEnum.GIFT_BUY then
        --礼包直购
        self.RedDotList["ActiveGift"] = trans.transform:Find("RedDotIcon").gameObject
    elseif self.ActivityData[idx].activityType == ActivityControl.activityTypeEnum.GIFT_GACHA then
        --礼包抽奖
        trans.transform:Find("RedDotIcon").gameObject:SetActive(false)
    elseif self.ActivityData[idx].activityType == ActivityControl.activityTypeEnum.PERSON_STORY then
...
function M:AddEvent()
    ...
    Event.Add("limitSignActivityDot",Handle(self,self.limitSignActivityDot))
    Event.Add("ChangePage",Handle(self,self.ChangePage))
end

function M:limitSignActivityDot()
    for i, v in pairs(RedDotControl.GetDotData("Activity").childNodeData) do
        if self.RedDotList[v.name] ~= nil then
            if v.name == "limitSign" then
                self.RedDotList[v.name]:SetActive(v.State)
            end
        end
    end
